...
//! is described here, and the golden test in `super::tests` refuses to pass
//! until `rosters/VOCABULARY.md` is regenerated to match. The doc cannot
//! drift: code → this renderer → the committed reference, one direction.
