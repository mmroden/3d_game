use crate::systems::asset_catalog::{WALL_ADJACENT_PROPS, CENTER_PROPS, CORNER_PROPS};
...
pub fn light_fixtures(
    ...
    use crate::systems::asset_catalog::CEILING_LIGHTS;
    use crate::systems::room_assembler::CELL_HEIGHT;
