...
use crate::systems::room_theme::RoomTheme;
...
mod tests {
    ...
    fn dense_populate_fills_majority_of_cells() {
        use crate::systems::room_theme::THEME_WAREHOUSE;
    ...
    fn sparse_populate_leaves_most_cells_empty() {
        use crate::systems::room_theme::{RoomTheme, PALETTE_GENERIC};
        use crate::systems::room_furnisher::RoomDensity;
        let sparse_theme = RoomTheme {
            name: "test_sparse",
            wall_set: &crate::systems::asset_catalog::WALL_SET_ASTRA,
